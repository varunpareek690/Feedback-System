...
mongoose.connect('mongodb+srv://varunpareek690:OPtonpere123@cluster0.ewfz7wk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', {
...
app.get('/api/protected', authenticateJWT, (req, res) => {
    res.status(200).json({ message: `Welcome, ${req.user.emailHost}`, wallet: req.user.walletAddress });
});
